# eider ![](reference/figures/eider_hexagon.png)
...
but running this every time you edit a file gets tiring quickly. To
automate this, first install the package with `make install`, and
install a working version of Python and also
...
To release a new version of the package, first update the version number
by running the following in the R shell. The following will prompt you
for a new version number (major, minor, or patch), which you can choose
according to semantic versioning considerations:
...
It’s probably also good to make sure that CI is passing on GitHub. When
you’re ready, commit and push to GitHub. Then:
