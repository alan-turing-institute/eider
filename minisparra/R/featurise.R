...
featurise <- function(all_tables,
  ...
  if (t == "count") {
    feature <- featurise_count(all_tables, spec)
  } else if (t == "sum") {
    feature <- featurise_sum(all_tables, spec)
  } else if (t == "nunique") {
    feature <- featurise_unique(all_tables, spec)
  } else if (t == "time_since") {
    feature <- featurise_time_since(all_tables, spec)
  } else {
