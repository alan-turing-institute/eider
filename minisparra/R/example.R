...
#'
#' @param file Name of the file to be used from inst/extdata. If NULL all files will be listed
#'
#' @return
#' @export
#'
...
#' minisparra_example("random_ae_data.csv") Returns path to the random A&E type file
minisparra_example <- function(file = NULL) {
  ...
  if (is.null(file)) {
    ...
    system.file("extdata", file, package = current_package_name, mustWork = TRUE)
  }
}
