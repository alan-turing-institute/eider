...
They have a slightly different structure to the rest: broadly speaking, these transformation types require a `feature_list` key, which is itself an object which contains the features which are to be combined.
