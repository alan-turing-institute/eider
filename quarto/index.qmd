...
```{r}
basic_ae_spec_filepath <- eider_example("spec_example_basic_ae_data.json")
...
Also note the `absent_default_value` has now been set to the string "NA", and a more descriptive `output_feature_name` has been given in the specification 
