...
## Just testing, everything below this should be ignored

```{r}
library(tidyverse)
output_column_name <- "years_since_first_entry"
cutoff_date <- lubridate::ymd("2023-03-19")
date_column_name <- "time"

all_tables$`../minisparra/tests/data/ae2.csv` %>%
